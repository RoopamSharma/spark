...
<?php 
$q="select * from recommend,register_emp where recommend.ID=register_emp.ID and recommend.jobid='".$_GET['jobid']."' and status='rejected' ORDER BY register_emp.experience desc";
...
<br/>
<input type="submit" name="resubmit"></input>
</form>
  </div>
  </div>
<?php } ?>
