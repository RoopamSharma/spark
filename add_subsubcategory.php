...
if(isset($_POST['submit']))
{
  ...
  $con->insertsubsub($cat_id,$subcat_name, $subsubcat_name,$subsubcat_details,$subsubcat_date,$subsubcat_time);
        ...
        <div id="page_wrapper">
            ...
            <nav id="breadcrumbs">
                <ul>
		            ...
		            <li><span>Add Subsubcategory</span></li>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <form class="form-horizontal" role="form" action="" method="post">
                                <h3 class="heading_a"><span class="heading_text">Add Subsubcategory Information</span></h3>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="subsubcat_name" value="" placeholder="Subsubcategory Name">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea cols="80" name="subsubcat_details" rows="10"></textarea>
                                    </div>
                                </div>
