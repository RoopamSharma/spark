...
if(isset($_POST['submit']))
{
  ...
  $subcat_date = date('d-m-Y');
  $subcat_time = date('h:i:s');

  $con->insertsub($cat_id,$subcat_name,$subcat_details,$subcat_date,$subcat_time);
 ?>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <form class="form-horizontal" role="form" action="" method="post">
                                <h3 class="heading_a"><span class="heading_text">Add Subcategory Information</span></h3>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="subcat_name" value="" placeholder="Subcategory Name">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea cols="80" name="subcat_details" rows="10"></textarea>
                                    </div>
                                </div>
