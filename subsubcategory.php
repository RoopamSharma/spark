...
{
	if(mysql_query("delete from subsubcategory where subsubcat_name=".$_REQUEST['ban_id']))
        ...
        <div id="page_wrapper">
            ...
            <nav id="breadcrumbs">
                <ul>
					...
					<li><a href="add_subsubcategory.php"><span style="margin-right:300px;">Add Subsubcategory</span></a></li>
		        </ul>
            </nav>
                            ...
                            <div class="row">
                                <div class="col-md-90">
                                    <table class="table table-yuk2 toggle-arrow-tiny" id="footable_demo" data-filter="#textFilter" data-page-size="5">
                                        <thead>
                                            <tr>
                                                <th data-toggle="true">Subsubcategory No.</th>
                                                <th>Category Name</th>
                                                <th>Subcategory Name</th>
                                                <th>Subsubcategory Name</th>
                                                <th>Subsubcategory Details</th>

                                                <th>Subsubcategory create Date</th>
                                                <th>Subsubcategory create Time</th>
                                                <th>Status</th>
                                            </tr>
                                        </thead>
                                        <tbody>
										...
										?>
                                            <tr>
                                                ...
                                                <td><!--<span class="label label-success status-active" title="Active">Active</span>--> <a href="edit_subsubcategory.php?id=<?php echo $row1['0']; ?>">Edit</a> </td>
                                            </tr>
                                           <?php
                                           $i=$i+1;
										 }
