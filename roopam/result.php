...
echo '<div align="center"><img style="height:60px;width:60px" src="images/Emoticons Sad.png"/></div>';    

	}
	else if($p==$v){
	
		echo '<p align="center">Congratulations Brilliant Performance!!</p>';
echo '<div align="center"><img style="height:60px;width:60px" src="images/Smiley-11-icon.png"/></div>';    
...
echo '<div align="center"><label><a id="hide" style="font-family:\'Comfortaa\',cursive;color:black;font-size:17px;margin-top:10px;" onclick="func1()">More Details</a></label></div>';
