...
<div>
        ...
        <label>About me: </label><?php echo $emp['aboutme']; ?>
         <br/>
        <a href="#" data-toggle="modal" data-target="#about-modal">Edit About</a>
...
<?php
    ...
    if ($abcd==0) { ?>
     ...
     <?php } else { ?>     
        ...
        <div>
     <div ><a href="#" data-toggle="modal" data-target="#twelve-modal">Edit</a></div>
         </div>
         
         </div>
     <?php } ?>
    </div>
      <div class="col-md-4 col-sm-8 col-xs-12" style="float:left;margin-left:10%"> 
            <?php 
...
echo ' <h4><strong>Graduation</strong></h4>';
     ...
     <?php } else { ?>     
        ...
        <div>
     <div ><a href="#" data-toggle="modal" data-target="#grad-modal">Edit</a></div>
         </div>
         </div>
     <?php } ?>
     <?php 
    ...
    <br
        ...
        <div>
     <div><a href="#" class="pg" data-id=<?php echo $edu['edu_id']?> data-toggle="modal" data-target="#pg-modal">Edit</a></div>
        <?php } ?>
         </div>
         </div>
...
<div class="col-md-4 col-sm-8 col-xs-12" style="margin-left:10%;margin-bottom:10%">
...
<div>
  <div>
          ...
          <br/>
          <div><a href="#" class="anchor" data-id=<?php echo $job['proid']?> data-toggle="modal" data-target="#job1-modal">Edit</a></div>
