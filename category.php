                            ...
                            <div class="row">
                                <div class="col-md-90">
                                    <table class="table table-yuk2 toggle-arrow-tiny" id="footable_demo" data-filter="#textFilter" data-page-size="5">
                                        <thead>
                                            <tr>
                                                <th data-toggle="true">Category No.</th>
                                                <th>Category Name</th>
										...
										?>
                                            <tr>
                                                ...
                                                <td><!--<span class="label label-success status-active" title="Active">Active</span>--> <a href="edit_category.php?id=<?php echo $row1['0']; ?>">Edit</a> 
                                                </tr>
                                           <?php
                                           $i=$i+1;
										 }
