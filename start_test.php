...
echo '<div>';
  ...
  {
  echo '<div id = "question_no" class="quest" style="width:80%;padding:0px">';
...
$a=0;
  ...
  <div style="width:200px;position:absolute;top:200px;right:50px;">
      <table class="table">
      <?php
for($i=1; $i<= $_SESSION['numberques']; $i++)
{
  echo '<tr><td>';
  echo '<div style="width:40px;">';
  echo '<label onClick=" showsomething(this.id); nextques1(this.id);" style="background-color:9E9E9E;color:white" id="'.$i.'" class="btn btn-default">'.$i. '</label>';
  echo '</div></td>';
  $i++;    
    if($i<= $_SESSION['numberques']){
  ...
  echo '</tr>';    
//echo '<span class="label label-default">'.$i. '</span>';
...
<?php  
echo '<div style="margin-bottom:40px;margin-left:280px;">';
...
<script>
    ...
    function func4(){
    var o=Number(document.getElementById("text1").value);
    alert(o);
        var radioVal=[];
//while()
var radioVal =$('input:radio[name=answer]:checked').val();
...
a=radioVal;
   ...
   var id12=Number(o)+1;  
    ...
    document.getElementById(id12).style.borderColor="red";
    document.getElementById(id12).style.color="white";
  }
        if(a!=0){
    document.getElementById(id12).style.backgroundColor="green";
    document.getElementById(id12).style.borderColor="green";
    document.getElementById(id12).style.color="white";
    }
}
    
function showsomething(id12)
{
 func4();   
    var o=Number(document.getElementById("text1").value);
    var radioVal=[];
...
req.open("GET", strURL, true);
   req.send(null);   
    ...
    function nextques1(ques) 
{  
    document.getElementById("text1").value=ques-1;
 if(ques-1==19){
 document.getElementById("submitbutton").removeAttribute("onclick");
 document.getElementById("submitbutton").setAttribute("onclick","func();");
}
 ...
 if (window.XMLHttpRequest) {
  ...
  var parameter="ques="+ques;
var target = "question.php";
