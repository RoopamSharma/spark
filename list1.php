...
if($i==0){
$sql=mysql_query("select * from userresult order by score desc");
$i=1;
}
else{
$sql=mysql_query("select * from userresult order by score asc");
$i=0;
}
}
else{
if($i==0){
$sql=mysql_query("select * from userresult where category='$p' order by score desc");
$i=1;
}
else{
$sql=mysql_query("select * from userresult where category='$p' order by score asc");
$i=0;
}
}
